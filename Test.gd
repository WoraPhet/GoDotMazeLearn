...
var currCH:int = 1
@onready var timelabel = get_node("/root/TestGamMain/Easy1/Fasttyping/Time")
@onready var timer = get_node("/root/TestGamMain/Easy1/Fasttyping/Timer")
@onready var promt = get_node("/root/TestGamMain/Easy1/Fasttyping/mainBG/Enemy")
